  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute bottom-0 right-0 h-[400px] w-[400px] rounded-full bg-pink-600/10 blur-[100px]" />
      </div>

      <div className="relative z-10 w-full max-w-md">
        {/* Logo */}
        <div className="mb-8 flex flex-col items-center text-center">
          <Link href="/" data-testid="signin-logo">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Sign in to continue your study journey</p>
        </div>
        ...
        <div className="rounded-2xl border border-border/40 bg-card/80 backdrop-blur-sm p-8 shadow-xl shadow-black/30">
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/signup" className="text-violet-400 hover:text-violet-300 font-medium transition-colors" data-testid="link-signup">
              Create one free
            </Link>
          </div>
        </div>
